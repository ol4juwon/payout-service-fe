...
const UserViewLeft = ({ userDetails }) => {
      ...
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            ...
            <CardContent sx={{ pb: 4 }}>
              ...
              <Box sx={{ pt: 4 }}>
                <Box sx={{ display: 'flex', mb: 3 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500 }}>Full Name:</Typography>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                  ...
                  <CustomChip
                    ...
                    color={statusColors[userDetails.active ? 'active' : 'inactive']}
                    sx={{
                      textTransform: 'capitalize'
                    }}
                  />
                  <Switch
                    onChange={async e => await toggleStatus(userDetails.id, !userDetails.active)}
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500 }}>Locked:</Typography>
                  <CustomChip
                    rounded
                    skin='light'
                    size='small'
                    label={userDetails.locked ? 'Account locked' : 'unlocked'}
                    color={statusColors[userDetails.locked ? 'inactive' : 'active']}
                    sx={{
                      textTransform: 'capitalize'
                    }}
                  />
                  <Switch
                    onChange={async e => await toggleStatus(userDetails.id, !userDetails.locked)}
                    sx={{ mr: 2, fontWeight: 500 }}
                    defaultChecked={!userDetails.locked}
                  />
                </Box>

                <Box sx={{ display: 'flex', mb: 3 }}>
                  <Typography sx={{ mr: 2, fontWeight: 500 }}>Blacklisted:</Typography>
                  <CustomChip
                    rounded
                    skin='light'
                    size='small'
                    label={userDetails.blacklisted ? 'Account blacklisted' : 'False'}
                    color={statusColors[userDetails.blacklisted ? 'inactive' : 'active']}
                    sx={{
                      textTransform: 'capitalize'
                    }}
                  />
            ...
            <UserSuspendDialog open={suspendDialogOpen} setOpen={setSuspendDialogOpen} userDetails={userDetails} />
